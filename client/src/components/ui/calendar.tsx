    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-pink-50 hover:text-pink-600"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-gradient-to-r from-pink-500 to-purple-500 text-white hover:bg-pink-600 hover:text-white focus:bg-pink-600 focus:text-white",
        day_today: "bg-pink-100 text-pink-600 font-bold",
        day_outside:
          "day-outside text-gray-400 opacity-50 aria-selected:bg-pink-50/50 aria-selected:text-gray-500 aria-selected:opacity-30",
