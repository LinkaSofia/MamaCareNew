                    ...
                    <div className="grid grid-cols-2 gap-3 md:gap-4 mb-6">
                      ...
                      <div className="bg-gradient-to-br from-blue-200 to-blue-400 backdrop-blur-sm border border-white/20 rounded-3xl p-4 md:p-6 shadow-xl hover:scale-105 transition-all duration-300">
                        <div className="flex items-center gap-2 mb-3 md:mb-4">
                          <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0">
                            <Calendar className="h-5 w-5 md:h-6 md:w-6 text-white" />
                          </div>
                          <span className="font-bold text-gray-800 text-xs md:text-base leading-tight break-words">
        ...
        <div className="px-4 mt-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-sm font-medium">Guia de Gestação</span>
            </Button>
            </div>
          </div>
